        ...
        <div className="row g-3 mb-4">
            <div className="col-md-6">
                <div className="card border border-secondary border-opacity-25 bg-white p-3 shadow-none rounded-2">
                    ...
                    <div className="h4 mb-0 fw-bold text-dark">₹{Number(totals.debit).toLocaleString()}</div>
                </div>
            </div>
            <div className="col-md-6">
                <div className="card border border-secondary border-opacity-25 bg-white p-3 shadow-none rounded-2">
                    <div className="small text-uppercase fw-bold text-muted opacity-75 mb-1">Total Credit (Purchases/Payable/Received In)</div>
                    <div className="h4 mb-0 fw-bold text-dark">₹{Number(totals.credit).toLocaleString()}</div>
                </div>
            </div>
        </div>
                ...
                <table className="table custom-tally-table mb-0">
                    ...
                    <tbody>
                        {loading ? (
                            ...
                            <tr><td colSpan="6" className="text-center py-5 text-muted border-0"><i className="bi bi-journal-x display-6 d-block mb-3 opacity-25"></i> No entries found for this period.</td></tr>
                        ) : entries.map(entry => (

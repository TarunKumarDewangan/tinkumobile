...
class Shop extends Model
{
    ...
    protected $fillable = ['name', 'address', 'phone', 'alt_phone', 'email', 'gstin', 'is_main', 'latitude', 'longitude', 'attendance_radius_meters', 'shift_start_time', 'shift_end_time', 'monthly_leave_limit'];

...
import SingleStockEntryModal from '../../../components/SingleStockEntryModal';
...
export default function OpeningStockForm({ 
  ...
  return (
    <form onSubmit={handleBulkSubmit}>
      ...
      <div className="pf-card">
        <div className="d-flex justify-content-between align-items-center mb-3">
          ...
          <div className="d-flex gap-2">
            ...
            <button type="button" className="pf-bulk shadow-sm" style={{background: 'linear-gradient(135deg, #10b981, #059669)', color: '#fff', border: 'none', letterSpacing: 0.5}} onClick={() => setShowSingleEntry(true)}>
              + Single Entry
            </button>
        ...
        {openingStockItems.length === 0 ? (
          <div className="text-center py-5" style={{background:'#f8fafc', borderRadius:12, border:'2px dashed #cbd5e1'}}>
            ...
            <div className="small text-muted mb-3">Use the buttons above to scan, add, or enter single inventory.</div>
            <div className="d-flex justify-content-center gap-2">
              ...
              <button type="button" className="btn btn-sm text-white fw-bold shadow-sm px-4" style={{background:'#10b981', borderRadius:20}} onClick={() => setShowSingleEntry(true)}>
                + Single Entry
              </button>
            </div>
          </div>
      ...
      <SingleStockEntryModal
        show={showSingleEntry}
        onHide={() => setShowSingleEntry(false)}
